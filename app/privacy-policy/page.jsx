            ...
            <ScrollBasedAnimation direction="up" delay={0.1}>
              <div className="relative inline-block max-w-3xl">
                ...
                <p className="relative text-xl lg:text-2xl text-blue-50 px-6 py-4">
                  {isRTL ? 'سياسة الخصوصية الخاصة بشركة المحاسبة الإبداعية - نحن ملتزمون بحماية خصوصيتك وبياناتك الشخصية.' : 'Creative Accounting Privacy Policy - We are committed to protecting your privacy and personal data.'}
                </p>
              </div>
            </ScrollBasedAnimation>
          </div>
