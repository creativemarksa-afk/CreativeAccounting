            ...
            <ScrollBasedAnimation direction="up" delay={0.1}>
              <div className="relative inline-block max-w-3xl">
                ...
                <p className="relative text-xl lg:text-2xl text-blue-50 px-6 py-4">
                  {isRTL ? 'شروط الخدمة الخاصة بشركة المحاسبة الإبداعية - اقرأ الشروط والأحكام لاستخدام خدماتنا.' : 'Creative Accounting Terms of Service - Read the terms and conditions for using our services.'}
                </p>
              </div>
            </ScrollBasedAnimation>
          </div>
